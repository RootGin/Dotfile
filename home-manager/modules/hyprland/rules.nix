...
in {
  config = mkIf cfg.enable {
    xdg.configFile."hypr/configs/rules.conf".text = ''
      # Base Rules
      ...
      # Float rules
      windowrulev2 = float, class:^(xfce-polkit|file_progress|confirm|dialog|download|notification|error|splash|confirmreset|wleave|nwg-look|nm-connection-editor|Picture-in-Picture)$
